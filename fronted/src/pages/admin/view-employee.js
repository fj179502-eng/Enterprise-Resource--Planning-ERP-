                            ...
                            employee.map((e,index)=>{
                                return(
                                    <tr key={e.employee_id}>
                                        ...
                                        <td>{e.cnic}</td>
                                        <td>
                                            <Link to={`/admin/update-employee/${e.employee_id}`} className="btn btn-success">Edit</Link>&nbsp;
                                            <button onClick={()=>deleteEmployee(e.employee_id)} className="btn btn-danger">Delete</button>
                                        </td>
                                    </tr>
                                )
                            })
