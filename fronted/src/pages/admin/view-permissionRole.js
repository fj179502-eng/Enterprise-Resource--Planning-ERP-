                            ...
                            permissionRole.map((rp,index)=>{
                                return(
                                    <tr key={rp.role_permission_id}>
                                        ...
                                        <td>
                                            <Link to={`/admin/update-permissionRole/${rp.role_permission_id}`} className="btn btn-success">Edit</Link>&nbsp;
...
export default ViewPermissionRole